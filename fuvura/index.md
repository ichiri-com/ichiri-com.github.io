...
NISA・iDeCo・特定口座など実際の口座をすべて入力しようとすると、無料プランの口座 3 件・商品 5 件にすぐ達します。プレミアムプランなら保有するすべての口座と商品をそのままモデル化できます。また、「楽観シナリオ vs 保守シナリオ」「退職年齢を 60 歳にした場合と 65 歳にした場合」など複数のプランを同じグラフ上で重ね描きして比較できるのも、プレミアムプラン限定の機能です。
